...
/*
  ...
  | Edited by:  Rajib Paudyal <rajib.mp@gmail.com>
  +----------------------------------------------------------------------+
*/
...
define('ADMIN_PASSWORD','memcache');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

// The path to the socket you are using. Feel free to add more sockets
// but remember to check if Memcached is actually using that socket or not.
// You can add more sockets like:
//$MEMCACHE_SERVERS[] = 'unix:///tmp/memcached2.sock';
$MEMCACHE_SERVERS[] = 'unix:///tmp/memcached.sock';
